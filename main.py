...
def create_graph(isos: list,
    ...
    fig = spiral_graph_with_fill_2_sides(dfs,cols = col, refactors=refactor, isos=isos, colors = colors, line_color = line_color)
    fig.savefig("graphs/nystyle_2fill_usa.jpg")
